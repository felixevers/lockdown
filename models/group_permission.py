...
class GroupToPermission(db.Model):
    ...
    group_id: db.Column = db.Column(db.String(36), db.ForeignKey("group.uuid"), primary_key=True, unique=True)
    permission_id: db.Column = db.Column(db.String(36), db.ForeignKey("permission.uuid"), primary_key=True, unique=True)
